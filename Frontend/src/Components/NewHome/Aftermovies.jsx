...
export default function Aftermovies() {
  ...
  const stats = [
    { label: 'Institutes', value: '50+', icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4' },
    { label: 'Prize Pool', value: '4L+', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
    { label: 'Events', value: '45+', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
    { label: 'Footfall', value: '45K+', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z' }
  ];
    ...
    <AnimatedDiv>
      <section className="relative z-10 w-full max-w-[1200px] mx-auto px-2 sm:px-6 md:px-8 pb-24 pt-12">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="lg:col-span-2 lg:row-span-2 rounded-[2.5rem] overflow-hidden relative group border border-white/10 shadow-2xl min-h-[350px] bg-black"
        >
          ...
          <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-black/80 via-transparent to-black/80 z-10"></div>
          ...
          <div className="absolute bottom-6 left-6 flex items-center gap-3 z-20 pointer-events-none">
            <div className="bg-white rounded-lg p-1.5 shadow-lg">
              <svg className="w-5 h-4 text-red-600" fill="currentColor" viewBox="0 0 24 24"><path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z" /></svg>
            </div>
            <span className="text-white text-xs sm:text-sm font-semibold tracking-wide drop-shadow-md">Official Trailer {activeTab}</span>
          </div>
        </motion.div>
        ...
        {stats.map((stat, index) => (
          <motion.div 
            ...
            viewport={{ once: true }}
            className="lg:col-span-1 bg-black/60 backdrop-blur-xl border border-white/10 rounded-[2rem] p-6 flex flex-col items-center justify-center relative overflow-hidden group hover:-translate-y-2 hover:bg-black/70 hover:border-white/20 transition-all duration-300"
          >
            ...
            <svg className="w-8 h-8 text-white/50 mb-3 group-hover:text-[#e8b5d6] transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
